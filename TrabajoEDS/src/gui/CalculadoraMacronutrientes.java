...
public class CalculadoraMacronutrientes {
	...
	private void initialize() {
		...
		panelListaAlimentos.setBackground(new Color(250, 209, 255));
		panelListaAlimentos.setLayout(new GridLayout(0, 3, 0, 0));
	 ...
	 * Crea un TextField para introducir los gramos consumidos y un JCheckBox con el nombre del alimento
	 *  
	...
	private void addRowAlimento(Alimento alimento) {
		...
		int gramosConsumidosInt = Integer.parseInt(gramosConsumidos.getText());		
		AlimentoCantidad alimentoCantidad = new AlimentoCantidad(alimento, gramosConsumidosInt);
		...
		/**
		 * Elimina el alimentoCantidad de la lista de alimentosCantidad, los elementos de la GUI que componen la fila y repinta el scroll
		 * 
		 * @author Marta
		 */
